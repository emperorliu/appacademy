...
ActiveRecord::Schema.define(version: 20141230190308) do
  ...
  add_index "responses", ["answer_id", "responder_id"], name: "index_responses_on_answer_id_and_responder_id", unique: true, using: :btree
